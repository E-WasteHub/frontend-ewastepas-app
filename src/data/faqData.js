export const faqData = [
  ...
  },
  {
    ...
    answer:
      'Perbedaan utamanya ada pada 3 hal: 1. Keamanan Lingkungan (kami bekerja dengan mitra formal yang mengelola limbah B3 dengan benar), 2. Keamanan Data (kami menjamin penghapusan data Anda secara tersertifikasi), dan 3. Keamanan Manusia (proses kami aman bagi pekerja, tidak seperti daur ulang informal yang berisiko tinggi).',
  },
  {
    question: 'Apakah data pribadi di perangkat saya akan aman?',
    answer:
      'Tentu. Keamanan data adalah prioritas utama kami. Kami menerapkan standar penghapusan data berlapis (certified data wiping) pada semua perangkat yang memiliki media penyimpanan sebelum masuk ke proses daur ulang. Anda akan menerima notifikasi setelah proses ini selesai.',
  },
  {
    question: 'Bagaimana jika perangkat saya sebenarnya masih bisa diperbaiki?',
    answer:
      'Kami sangat mendukung prinsip Reduce, Reuse, dan Repair. Jika Anda merasa perangkat masih layak, kami sarankan untuk memperbaikinya terlebih dahulu. Namun, jika Anda tetap ingin menyerahkannya, tim kami akan melakukan penilaian. Perangkat yang masih berfungsi baik akan kami salurkan untuk digunakan kembali, bukan langsung didaur ulang.',
  },
  {
