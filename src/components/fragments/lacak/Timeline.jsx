...
import { formatTanggalWaktuIndonesia } from '../../../utils/penjemputanUtils';

const Timeline = ({ steps = [], currentStep = 0, isDarkMode, detail }) => {
  if (currentStep === -1) {
    return (
      <div
  ...
  return (
    <div className='space-y-4'>
      {steps.map((step, index) => {
        ...
        const timeLabel = formatTanggalWaktuIndonesia(timeValue);
