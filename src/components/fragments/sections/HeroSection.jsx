...
const HeroSection = () => {
  ...
  return (
    <section
      className={`relative flex items-center min-h-screen px-4 lg:px-8 ${
    ...
    >
      ...
      <div className='relative z-10 flex flex-col-reverse items-center w-full max-w-7xl gap-8 py-16 mx-auto lg:flex-row lg:gap-16'>
        {/* Left Content */}
        <Motion.div
        ...
        >
          ...
          <h1
            className={`mt-4 text-4xl lg:text-6xl font-bold tracking-tight ${
          ...
          <p
            className={`max-w-xl mx-auto lg:mx-0 mt-4 text-lg leading-relaxed ${
          ...
          <div className='flex flex-col justify-center gap-4 mt-8 sm:flex-row lg:justify-start'>
            <Link to='/register'>
              <Button className='w-full sm:w-auto !px-12 py-3 !text-base font-semibold'>
                Mulai Sekarang
              </Button>
            </Link>
        ...
        <Motion.div className='flex items-center justify-center flex-1 w-full'>
          <div className='w-full mt-12 max-w-sm lg:max-w-md'>
            <Motion.img
